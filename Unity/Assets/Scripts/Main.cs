...
public class Main : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		fparams.backgroundColor = Color.white;//new Color(0.1f, 0.1f, 0.1f);
	...
	public void GoToPage (PageType pageType)
	{
		...
		case PageType.MainPage:
			...
			break;
		case PageType.CellularAutomatonPage:
			pageToCreate = new CellularAutomatonPage();
			break;
		case PageType.LineMatcherPage:
			pageToCreate = new LineMatcherPage();
			break;
		case PageType.WindGame:
			pageToCreate = new WindGamePage();
			break;
		case PageType.LeaderboardTest:
			pageToCreate = new LeaderboardTestPage();
			break;
		case PageType.ArenaGame:
			pageToCreate = new ArenaGamePage();
			break;
		}
